 ...
 * （docker-compose 内为 http://engine-py:8000，本地直跑为 http://localhost:8000）。
 *
...
public class EngineClientConfig {
    ...
    @Bean
    public RestClient engineRestClient(@Value("${engine.base-url:http://localhost:8000}") String baseUrl) {
